...
dependencies {
    ...
    implementation("no.nav.common:rest:2.2021.09.03_14.08-6d71358df566")
    implementation("com.google.code.gson:gson:2.8.6")

    // Kontrakter
    implementation("no.nav.k9.sak:kontrakt:3.2.14")
    implementation("no.nav.k9.sak:kodeverk:3.2.14")
