...
class AksjonspunktTest {
    ...
    fun `Skal takle utgått aksjonspunkt`() {
        val oppgave = Oppgave(
            ...
            aksjonspunkter = Aksjonspunkter(mapOf("5002" to AksjonspunktStatus.OPPRETTET.kode)),
            tilBeslutter = false,
    ...
    fun `Skal få true på auto aksjonspunkt`() {
        val oppgave = Oppgave(
            ...
            eksternId = UUID.randomUUID(),
            oppgaveEgenskap = emptyList(),
            aksjonspunkter = Aksjonspunkter(mapOf("7030" to AksjonspunktStatus.OPPRETTET.kode)),
            tilBeslutter = false,
            utbetalingTilBruker = false,
            selvstendigFrilans = false,
            kombinert = false,
