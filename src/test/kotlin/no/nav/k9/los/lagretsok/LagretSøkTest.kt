...
class LagretSøkTest {
    ...
    fun `equals skal være false mot null`() {
        val lagretSøk = LagretSøk.nyttSøk(Områder.K9, saksbehandler, NyttLagretSøkRequest("Test", LagretSøk.defaultQuery(Områder.K9, false)))
    ...
    fun `equals skal være true for objekter med samme id når begge har id`() {
        val lagretSøk1 = LagretSøk.fraEksisterende(1L, 123L, Områder.K9, 1L, "Tittel1", "Beskrivelse1", LocalDateTime.now())
        val lagretSøk2 = LagretSøk.fraEksisterende(1L, 123L, Områder.K9, 2L, "Tittel2", "Beskrivelse2", LocalDateTime.now())
    ...
    fun `equals skal være false for objekter med forskjellig id`() {
        val lagretSøk1 = LagretSøk.fraEksisterende(1L, 123L, Områder.K9, 1L, "Tittel", "Beskrivelse", LocalDateTime.now())
        val lagretSøk2 = LagretSøk.fraEksisterende(2L, 123L, Områder.K9, 1L, "Tittel", "Beskrivelse", LocalDateTime.now())
    ...
    fun `equals skal være false når ett objekt har id og det andre ikke`() {
        val lagretSøkUtenId = LagretSøk.nyttSøk(Områder.K9, saksbehandler, NyttLagretSøkRequest("Test", LagretSøk.defaultQuery(Områder.K9, false)))
        val lagretSøkMedId = LagretSøk.fraEksisterende(1L, 123L, Områder.K9, 1L, "Test", "Beskrivelse", LocalDateTime.now())
    ...
    fun `equals skal bruke object identity for objekter uten id`() {
        val lagretSøk1 = LagretSøk.nyttSøk(Områder.K9, saksbehandler, NyttLagretSøkRequest("Test", LagretSøk.defaultQuery(Områder.K9, false)))
        val lagretSøk2 = LagretSøk.nyttSøk(Områder.K9, saksbehandler, NyttLagretSøkRequest("Test", LagretSøk.defaultQuery(Områder.K9, false)))
