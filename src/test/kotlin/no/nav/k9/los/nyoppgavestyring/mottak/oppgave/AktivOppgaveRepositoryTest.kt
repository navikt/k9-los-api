...
class AktivOppgaveRepositoryTest {
    ...
    fun `grisecase`() {
        ...
        assertThat(diffResultat.updates.values.first()).isEqualTo(AktivOppgaveRepository.Verdi("1111", null, 1, "aksjonspunkt"))
        ...
        assertThat(diffResultat.inserts).containsOnly(AktivOppgaveRepository.Verdi("test2", null, 3, "test2"))
    }
