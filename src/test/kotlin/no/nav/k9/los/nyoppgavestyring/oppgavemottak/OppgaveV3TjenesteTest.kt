...
class OppgaveV3TjenesteTest : AbstractK9LosIntegrationTest() {
    ...
    private fun lagOppgaveDto(eksternId: String, versjon: Int, oppgavestatus: Oppgavestatus, aksjonspunkt: String?): no.nav.k9.los.nyoppgavestyring.oppgavemottak.OppgaveDto {
        return OppgaveDto(
            eksternId = eksternId,
