...
class OppgaveKoTest : AbstractK9LosIntegrationTest() {
    ...
    fun `sjekker at oppgavekø kan opprettes og slettes`() {
        ...
        val oppgaveKo = oppgaveKoRepository.leggTil("Testkø", kode6 = false)
    ...
    fun `sjekker at oppgavekø kan endres`() {
        ...
        val tittel = "Testkø"
        val oppgaveKo = oppgaveKoRepository.leggTil(tittel, kode6 = false)
    ...
    fun `oppgavekø skal kunne kopieres`() {
        ...
        val nyOppgaveKo = oppgaveKoRepository.kopier(gammelOppgaveko.id, nyTittel, true, true, false)
