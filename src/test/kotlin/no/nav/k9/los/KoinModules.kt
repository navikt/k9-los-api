...
import no.nav.k9.los.infrastruktur.abac.tilganger.IngenPdpTilgangsskygge
...
fun buildAndTestConfig(dataSource: DataSource, pepClient: IPepClient = PepClientLocal()): Module = module {
    ...
    single { pepClient }
    single { BrukerkontekstFactory(Gruppeoppsett(), IngenPdpTilgangsskygge, lokaleTilganger = true) }
