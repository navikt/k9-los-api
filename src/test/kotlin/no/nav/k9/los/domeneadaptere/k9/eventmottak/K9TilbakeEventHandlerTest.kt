...
class K9TilbakeEventHandlerTest : AbstractK9LosIntegrationTest() {
    ...
    private fun hentOppgaveForEksternId(eksternId: String): no.nav.k9.los.oppgaveuthenting.Oppgave? {
        return transactionalManager.transaction { tx ->
            oppgaveRepository.hentNyesteOppgaveForEksternIdHvisFinnes(tx, Områder.K9, eksternId)
        }
    }
