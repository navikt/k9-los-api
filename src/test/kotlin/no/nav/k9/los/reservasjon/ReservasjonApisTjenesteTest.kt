...
class ReservasjonApisTjenesteTest {
    ...
    fun `ny reservasjonsmetode bygger alle oppgaver i ett builder-kall`() = runBlocking {
        ...
        every { oppgave1.oppgavetype.område.eksternId } returns "K9"
        every { oppgave2.oppgavetype.område.eksternId } returns "K9"
        ...
        val saksbehandler = Saksbehandler(1, "Z123456", "Saks Behandler", "saks@nav.no", null, listOf(Områder.K9), false)
        ...
        every { reservasjonV3Tjeneste.hentReservasjonerForSaksbehandler(1, Områder.K9) } returns listOf(
