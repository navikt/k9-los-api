package no.nav.k9.los.nøkkeltall.avdelingsleder.status
...
class StatusService(
    ...
    fun hentStatus(harTilgangTilKode6: Boolean): List<StatusDto> {
        ...
        val resultat = queryService.query(QueryRequest(oppgaveQuery, område = Områder.K9, harTilgangTilKode6 = harTilgangTilKode6))
