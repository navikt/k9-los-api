...
class InnloggetBrukerTjeneste(
    ...
    suspend fun hentInnloggetBruker(
        ...
        val saksbehandler = finnOgVedlikehold(
            ...
            skjermet = bruker.harTilgangTilKode6,
        )
    ...
    private suspend fun finnOgVedlikehold(navIdent: String, token: IIdToken, skjermet: Boolean): Saksbehandler? {
        ...
        if (saksbehandler == null) {
            ...
            vedlikeholdHvisUtdatert(saksbehandler, navIdent, token, skjermet)
        }
