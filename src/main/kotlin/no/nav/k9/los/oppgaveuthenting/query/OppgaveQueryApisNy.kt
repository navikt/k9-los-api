    ...
    post("/antall", {
        ...
        medBrukerkontekst { bruker ->
            if (bruker.harBasisTilgang) {
                ...
                call.respond(oppgaveQueryService.queryForAntall(QueryRequest(oppgaveQuery, false, område = område, harTilgangTilKode6 = bruker.harTilgangTilKode6)))
            } else {
    ...
    post("/validate", {
        ...
        medBrukerkontekst { bruker ->
            if (bruker.harBasisTilgang) {
                val område = bruker.område
                val oppgaveQuery = call.receive<OppgaveQuery>()
                call.respond(oppgaveQueryService.validate(QueryRequest(oppgaveQuery, område = område, harTilgangTilKode6 = bruker.harTilgangTilKode6)))
            } else {
                call.respond(HttpStatusCode.Forbidden)
            }
        }
