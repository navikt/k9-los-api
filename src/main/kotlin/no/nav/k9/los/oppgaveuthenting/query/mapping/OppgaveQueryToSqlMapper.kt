package no.nav.k9.los.oppgaveuthenting.query.mapping

import no.nav.k9.los.oppgavedefinisjon.Oppgavestatus
import no.nav.k9.los.oppgaveuthenting.query.QueryRequest
import no.nav.k9.los.oppgaveuthenting.query.db.*
...
object OppgaveQueryToSqlMapper {
    private fun utledSqlBuilder(
        ...
        return PartisjonertOppgaveQuerySqlBuilder(felter, oppgavestatusFilter, now, ferdigstiltDatofilter, request.område, request.harTilgangTilKode6)
    }
