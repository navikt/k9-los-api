package no.nav.k9.los.domeneadaptere.eventtiloppgave.k9.saktillos
...
object SakEventTilOppgaveMapper {
    fun lagOppgaveDto(
        ...
        oppgaveDto = ryddOppObsoleteYtelse(event, oppgaveDto)

        if (eventLagret.erVaskeevent) {
    ...
    /**
     * Behandlinger på OBSOLETE ytelsestype skal alltid lukkes som feilopprettet.
     * Resultatfeil fra 2020 (AVSLU + IKKE_FASTSATT) rettes opp av EventBeriker før mapping.
     */
    @VisibleForTesting
    internal fun ryddOppObsoleteYtelse(
        event: K9SakEventDto,
    ...
    private fun mapEnkeltverdier(
        ...
        event.relevanteSøknadsperioder?.let {
            OppgaveFeltverdiDto(
                ...
                verdi = event.relevanteSøknadsperioder.sumOf { periode ->
