package no.nav.k9.los.domeneadaptere.k9.avstemming
...
class AvstemmingsTjeneste(
    ...
    suspend fun avstem(fagsystem: Fagsystem) : Avstemmingsrapport {
        ...
        return when (fagsystem) {
            ...
            Fagsystem.UNGSAK, Fagsystem.UNGTILBAKE -> throw UnsupportedOperationException("Fagsystem $fagsystem is not implemented yet")
        }
    }
}