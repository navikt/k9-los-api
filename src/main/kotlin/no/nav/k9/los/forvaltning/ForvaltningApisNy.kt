...
fun Route.forvaltningApisNy() {
    ...
    get("/index_oversikt", {
        ...
        // Global, skrivebeskyttet databaseindeksoversikt. Ingen oppgave- eller områdedata.
        ...
        medBrukerkontekst { bruker ->
            if (bruker.harDriftstilgang) {
                ...
                val sokefelt = when (fagsystem) {
                    ...
                    Fagsystem.UNGSAK, Fagsystem.UNGTILBAKE -> throw SecurityException("Fagsystem uten støttet område")
                }
