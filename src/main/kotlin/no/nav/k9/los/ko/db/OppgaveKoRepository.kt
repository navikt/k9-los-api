...
class OppgaveKoRepository(
    ...
    fun slett(oppgaveKoId: Long, område: Områder, skjermet: Boolean) {
        using(sessionOf(datasource)) { session ->
            session.transaction { tx -> slett(tx, oppgaveKoId, område, skjermet) }
        }
    }

    fun slett(tx: TransactionalSession, oppgaveKoId: Long, område: Områder, skjermet: Boolean) {
        ...
        hent(tx, oppgaveKoId, skjermet, område)
