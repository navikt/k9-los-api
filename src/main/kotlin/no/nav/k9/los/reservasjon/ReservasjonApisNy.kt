        ...
        medBrukerkontekst { bruker ->
            ...
            if (bruker.harTilgangTilReserveringAvOppgaver) {
                ...
                try {
                    ...
                    val oppgave = reservasjonApisTjeneste.reserverOppgave(innloggetBruker, oppgaveNøkkel, skjermet, bruker)
        ...
        medBrukerkontekst { bruker ->
            ...
            if (bruker.harBasisTilgang) {
                ...
                if (innloggetBruker != null) {
                    val reservasjoner = reservasjonApisTjeneste.hentReserverteOppgaverSammendragForSaksbehandler(innloggetBruker, bruker)
        ...
        medBrukerkontekst { bruker ->
            ...
            if (bruker.harBasisTilgang) {
                ...
                try {
                    ...
                    reservasjonApisTjeneste.annullerReservasjoner(params, innloggetBruker, bruker)
    ...
    get("/aktiv-reservasjon", {
        ...
        medBrukerkontekst { bruker ->
            if (bruker.harBasisTilgang) {
                ...
                val aktivReservasjon = try {
                    reservasjonApisTjeneste.hentAktivReservasjon(oppgaveNøkkel, bruker)
                } catch (e: ManglerTilgangException) {
                    call.respond(HttpStatusCode.Forbidden)
