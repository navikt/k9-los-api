...
class EventTilDtoMapper(
    ...
    internal fun lagOppgaveDto(
        ...
        return OppgaveDto(
            ...
            feltverdier = lagFeltverdier(event, oppgavestatus, losOpplysningerSomManglerIKlageDto, forrigeOppgave)
        )
    }
    ...
    private fun lagFeltverdier(
        ...
        val oppgaveFeltverdiDtos =
            mapEnkeltverdier(event, oppgavestatus, losOpplysningerSomManglerIKlageDto, forrigeOppgave)
