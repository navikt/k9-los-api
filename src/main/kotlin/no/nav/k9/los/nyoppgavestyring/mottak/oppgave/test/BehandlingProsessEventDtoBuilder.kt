...
class BehandlingProsessEventDtoBuilder(
    ...
    fun hosBeslutter(ansvarligSaksbehandler: Saksbehandler?): BehandlingProsessEventDtoBuilder {
    ...
    fun beslutterGodkjent(ansvarligBeslutter: Saksbehandler?): BehandlingProsessEventDtoBuilder {
        this.behandlingStatus = BehandlingStatus.UTREDES
        this.behandlingSteg = BehandlingStegType.FATTE_VEDTAK
        this.resultatType = BehandlingResultatType.INNVILGET
        this.aksjonspunkter = mutableListOf(
    ...
    fun avsluttet(ansvarligBeslutter: Saksbehandler?): BehandlingProsessEventDtoBuilder {
