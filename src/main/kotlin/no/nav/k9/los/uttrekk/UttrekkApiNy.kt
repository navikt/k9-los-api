        ...
        medBrukerkontekst { bruker ->
            if (bruker.harBasisTilgang) {
                ...
                if (innloggetSaksbehandler == null) {
                    ...
                    val uttrekk = uttrekkTjeneste.hentForSaksbehandler(innloggetSaksbehandler.id, område, bruker.harTilgangTilKode6)
            ...
            if (bruker.harBasisTilgang) {
                ...
                if (innloggetSaksbehandler == null) {
                    ...
                    try {
                        ...
                        val uttrekkId = uttrekkTjeneste.opprett(request, innloggetSaksbehandler.id, område, bruker.harTilgangTilKode6)
    ...
    delete("lagret-sok/{lagretSokId}", {
        ...
        medBrukerkontekst { bruker ->
            if (bruker.harBasisTilgang) {
                ...
                val antallSlettet = uttrekkTjeneste.slettForLagretSøk(lagretSokId, saksbehandler.id, område, bruker.harTilgangTilKode6)
    ...
    get("{id}/csv", {
        ...
        medBrukerkontekst { bruker ->
            if (bruker.harBasisTilgang) {
                ...
                val saksbehandler = saksbehandlerRepository.finnSaksbehandlerMedIdent(bruker.navIdent, bruker.harTilgangTilKode6)
                    ?: throw SecurityException("Ingen tilgang til uttrekk")
                val resultat = uttrekkTjeneste.hentResultat(id, saksbehandler.id, område, bruker.harTilgangTilKode6)
                if (resultat == null) {
    ...
    get("{id}/json", {
        ...
        medBrukerkontekst { bruker ->
            if (bruker.harBasisTilgang) {
                ...
                val saksbehandler = saksbehandlerRepository.finnSaksbehandlerMedIdent(bruker.navIdent, bruker.harTilgangTilKode6)
                    ?: throw SecurityException("Ingen tilgang til uttrekk")
                val resultatJson = uttrekkTjeneste.hentResultat(id, saksbehandler.id, område, bruker.harTilgangTilKode6)
