...
create index ofv_oppgave_id_verdi_idx on oppgavefelt_verdi_part (oppgave_id, feltdefinisjon_ekstern_id, verdi);
create index ofv_oppgave_id_verdi_bigint_idx on oppgavefelt_verdi_part (oppgave_id, feltdefinisjon_ekstern_id, verdi_bigint) where verdi_bigint is not null;

create index ofv_feltdefinisjon_verdi_idx on oppgavefelt_verdi_part (feltdefinisjon_ekstern_id, verdi, oppgave_id);
create index ofv_feltdefinisjon_verdi_bigint_idx on oppgavefelt_verdi_part (feltdefinisjon_ekstern_id, verdi_bigint, oppgave_id) where verdi_bigint is not null;

create index ofv_lukket_ferdigstilt_dato_verdi_idx on oppgavefelt_verdi_lukket_part (ferdigstilt_dato desc, feltdefinisjon_ekstern_id, verdi, oppgave_id);
create index ofv_lukket_ferdigstilt_dato_verdi_bigint_idx on oppgavefelt_verdi_lukket_part (ferdigstilt_dato desc, feltdefinisjon_ekstern_id, verdi_bigint, oppgave_id) where verdi_bigint is null;